...
class Waypoint {
  ...
  static getMessageSize(object) {
    ...
    length += object.lane_change.length;
    length += object.lane_type.length;
    length += object.right_lane_marking.length;
    length += object.left_lane_marking.length;
    length += object.vunit.length;
    return length + 104;
  }
  ...
  static md5sum() {
    ...
    return '88d65e87c7d364aeb648946a433a542d';
  }
