...
class Waypoint(genpy.Message):
  _md5sum = "88d65e87c7d364aeb648946a433a542d"
...
float64 yaw
float64 roll"""
  __slots__ = ['header','id','transform','road_id','lane_id','junction','s','lane_width','lane_change','lane_type','right_lane_marking','left_lane_marking','vmax','vunit']
  _slot_types = ['std_msgs/Header','int32','t4ac_msgs/Transform','int32','int32','int32','float64','float64','string','string','string','string','int32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,transform,road_id,lane_id,junction,s,lane_width,lane_change,lane_type,right_lane_marking,left_lane_marking,vmax,vunit
