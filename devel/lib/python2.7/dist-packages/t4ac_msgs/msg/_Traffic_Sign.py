...
class Traffic_Sign(genpy.Message):
  _md5sum = "6e8d6f52df972c44ccb99a01b6e684d4"
...
float64 w
"""
  __slots__ = ['type','lanes','x1','y1','x2','y2','local_pose','global_pose']
  _slot_types = ['string','uint8[]','float64','float64','float64','float64','geometry_msgs/PoseWithCovariance','geometry_msgs/PoseWithCovariance']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       type,lanes,x1,y1,x2,y2,local_pose,global_pose
